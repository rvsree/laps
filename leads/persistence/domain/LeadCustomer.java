...
@Component
public class LeadCustomer implements Serializable {

	public LeadCustomer() {
	}

	public LeadCustomer(String customerId, String firstName, String lastName, Date dateOfBirth, int age, String gender,
	...
	public static Comparator<LeadCustomer> ageComparator = new Comparator<LeadCustomer>() {
		@Override
		public int compare(LeadCustomer leadCustomer1, LeadCustomer leadCustomer2) {
			return (leadCustomer2.getAge() < leadCustomer1.getAge() ? -1
					: (leadCustomer2.getAge() == leadCustomer1.getAge() ? 0 : 1));
		}
	};

	public static Comparator<LeadCustomer> nameComparator = new Comparator<LeadCustomer>() {
		@Override
		public int compare(LeadCustomer leadCustomer1, LeadCustomer leadCustomer2) {
