...
import com.mortgage.maps.persistence.helper.SqlQueryManager;
import com.mortgage.maps.utils.config.DataSourceConfig;
...
public class MapsDAOImpl implements MapsDAO {
	...
	@Override
	public Customer getCustomerById(String sqlCustomer, String Id) {
	...
	@Override
	public List<Customer> getAllCustomers(String sqlCustomer) {
	...
	public void saveCustomer(Customer customer) throws DAOException {
		try {
			System.out.println("DAO: before insert: " + customer);
			...
			System.out.println("DAO: after save: " + customer);
		} catch (Exception ex) {
